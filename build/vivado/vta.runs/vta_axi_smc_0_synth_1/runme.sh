...
HD_PWD='/home/mohamad/Documents/CSE599/lab1/build/vivado/vta.runs/vta_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vta_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vta_axi_smc_0.tcl
