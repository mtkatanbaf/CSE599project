...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CONTROL_BUS m_axi_ins_port m_axi_uop_port m_axi_narrow_port m_axi_wide_port"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_narrow_port {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_narrow_port"
        data_width "128"
        param_prefix "C_M_AXI_NARROW_PORT"
    ...
    m_axi_wide_port {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_wide_port"
        data_width "512"
        param_prefix "C_M_AXI_WIDE_PORT"
...
set enable_xo_gen 0
set kernel_files {/home/mohamad/Documents/CSE599/lab1/src/vta.cc}
if {$enable_xo_gen} {
