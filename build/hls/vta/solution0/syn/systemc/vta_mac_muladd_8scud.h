...
#ifndef __vta_mac_muladd_8scud__HH__
#define __vta_mac_muladd_8scud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(vta_mac_muladd_8scud) {
    ...
    SC_CTOR(vta_mac_muladd_8scud):  simcore_mac_1_U ("simcore_mac_1_U") {
