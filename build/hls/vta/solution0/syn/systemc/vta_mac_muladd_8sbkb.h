...
#ifndef __vta_mac_muladd_8sbkb__HH__
#define __vta_mac_muladd_8sbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(vta_mac_muladd_8sbkb) {
    ...
    SC_CTOR(vta_mac_muladd_8sbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
